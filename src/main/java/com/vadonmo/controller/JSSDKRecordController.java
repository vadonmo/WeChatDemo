...
@Controller
@RequestMapping("jssdkRecord")
public class JSSDKRecordController {
	@RequestMapping("")
	protected String getRecordInfo(HttpServletResponse response, HttpServletRequest request, Model model)
			throws Exception {
