...
@Controller
@RequestMapping("jssdkLocation")
public class JSSDKLocationController {
	@RequestMapping("")
	protected String getLocation(HttpServletResponse response, HttpServletRequest request, Model model)
			throws Exception {
