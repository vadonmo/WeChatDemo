...
@Controller
@RequestMapping("jssdkWxCard")
public class JSSDKWxCardController {
	@RequestMapping("")
	protected String getWxCard(HttpServletResponse response, HttpServletRequest request, Model model) throws Exception {
