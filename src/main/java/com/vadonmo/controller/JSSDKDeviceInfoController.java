...
@Controller
@RequestMapping("jssdkDeviceInfo")
public class JSSDKDeviceInfoController {
	@RequestMapping("")
	protected String DeviceInfo(HttpServletResponse response, HttpServletRequest request, Model model)
			throws Exception {
